      ...
      <div className="h-screen bg-gray-100 pt-20">
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                  ...
                  <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                    ...
                    <div className="flex items-center space-x-4">
                      <p className="text-lg text-[#0073a8] font-bold">
                        $ {cartData?.travel.price}
                      </p>
                      <button onClick={() => handleRemove(cartData._id)}>
                        X
                      </button>
                    </div>
                  </div>
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
            ...
            <Link
              to="/Book"
              className="btn block mt-6 w-full rounded-md bg-[#0073a8] py-1.5 font-medium text-blue-50 hover:bg-blue-600 text-center"
            >
              Check out
            </Link>
          </div>
