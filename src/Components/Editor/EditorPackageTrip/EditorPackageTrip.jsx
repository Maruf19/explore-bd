      ...
      <div className="my-6 flex justify-center items-center">
        <div className="w-full flex justify-center">
          ...
          >
            ...
            <input
              className="w-1/2 mb-5 ml-40 cursor-pointer border-2 hover:shadow-lg transition-all duration-300 ease-in-out hover:text-black text-white text-center bg-[#0073a8] hover:bg-[transparent]  p-2 rounded-full"
              type="submit"
              value="Add Snap"
            />
          </form>
